...
public class GUITransactions {
	...
	private GUIGymDelegate delegate = null;
	 ...
	 */
	public void setupDatabase(GUIGymDelegate delegate) {
	 ...
	 */ 
	public void showMainMenu(GUIGymDelegate delegate) {
		this.delegate = delegate;
...
//		GymModel model = new GymModel(address,
//											city,
//											id,
//											name,
//											phoneNumber);
//		delegate.insertMember(model);
	}
